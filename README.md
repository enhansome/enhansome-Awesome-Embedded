...
* [Coding Interview University](https://github.com/jwasham/coding-interview-university) ⭐ 360,894 | 🐛 125 | 📅 2025-08-28 - A complete computer science study plan to become a software engineer.
...
* [Bare metal programming guide](https://github.com/cpq/bare-metal-programming-guide) ⭐ 4,875 | 🐛 2 | 🌐 C | 📅 2026-07-03 - a detailed guide for beginners
...
* [Standalone TCP/IP stack for STM32, bare metal or RTOS](https://github.com/cesanta/mongoose) ⭐ 13,038 | 🐛 3 | 🌐 C | 📅 2026-09-14
...
* [Lightweight USB device Stack for STM32 microcontrollers](https://github.com/dmitrystu/libusb_stm32) ⭐ 829 | 🐛 29 | 🌐 C | 📅 2025-10-06

* [libopencm3 and FreeRTOS projects using the STM32F103C8T6 MCU](https://github.com/ve3wwg/stm32f103c8t6) ⭐ 394 | 🐛 12 | 🌐 C | 📅 2023-11-18

* [DFU Bootloader for STM32 chips](https://github.com/devanlai/dapboot) ⭐ 383 | 🐛 13 | 🌐 C | 📅 2025-02-22
...
* [Bare metal Raspberry Pi 3 tutorials](https://github.com/bztsrc/raspi3-tutorial) ⭐ 3,050 | 🐛 6 | 🌐 C | 📅 2024-06-21
...
* [Linux inside](https://github.com/0xAX/linux-insides) ⭐ 33,494 | 🐛 24 | 🌐 Python | 📅 2026-09-14 - A little bit about a linux kernel
...
* [RT-Thread is an open source IoT operating system from China.](https://github.com/RT-Thread/rt-thread) ⭐ 12,219 | 🐛 489 | 🌐 C | 📅 2026-09-14
...
* [tock](https://github.com/tock/tock) ⭐ 6,442 | 🐛 216 | 🌐 Rust | 📅 2026-09-14 - A secure embedded operating system for Cortex-M based microcontrollers.
* [AliOS-Things](https://github.com/alibaba/AliOS-Things) ⭐ 4,627 | 🐛 74 | 🌐 C | 📅 2023-07-04 - AliOS Things released by Alibaba is an open-source implementation of operating system (OS) for Internet of Things (IoT).
...
* [Real-Time Kernel '0'](https://github.com/antoniogiacomelli/RK0) ⭐ 15 | 🐛 0 | 🌐 C | 📅 2026-09-14 - A lean, highly deterministic, low-latency real-time kernel for ARMv6/7M.
...
* [BlackFlag ECU](https://github.com/bad-antics/blackflag-ecu) ⭐ 38 | 🐛 3 | 📅 2026-02-27 - Automotive CAN bus security testing and analysis tool for ECU research, fuzzing, and reverse engineering of vehicle communication protocols.

## OS

* [Bootstrap yourself to write an OS from scratch. A book for self-learner.](https://github.com/tuhdo/os01) ⭐ 13,704 | 🐛 66 | 🌐 TeX | 📅 2024-03-26
* [A simple OS kernel for research, teaching, and fun](https://github.com/dthain/basekernel) ⭐ 939 | 🐛 19 | 🌐 C | 📅 2026-01-08
...
* [tinyusb](https://github.com/hathach/tinyusb) ⭐ 7,094 | 🐛 267 | 🌐 C | 📅 2026-09-14 - An open source USB stack for a variety of Embedded Systems.

## Others

* [apollo](https://github.com/ApolloAuto/apollo) ⭐ 26,826 | 🐛 1,047 | 🌐 C++ | 📅 2026-04-16 - An open autonomous driving platform.
* [A C++ template library for embedded applications](https://github.com/ETLCPP/etl) ⭐ 3,118 | 🐛 58 | 🌐 C++ | 📅 2026-09-14
* [Advanced fault backtrace library for ARM Cortex-M series MCU](https://github.com/armink/CmBacktrace) ⭐ 2,174 | 🐛 48 | 🌐 C | 📅 2026-05-21
* [DirtyJTAG](https://github.com/jeanthom/DirtyJTAG) ⭐ 629 | 🐛 10 | 🌐 C | 📅 2026-03-10 - JTAG adapter firmware for STM32F1
...
* [Serial Studio](https://github.com/Serial-Studio/Serial-Studio) ⭐ 7,194 | 🐛 21 | 🌐 C | 📅 2026-09-14 - Visualize, analyze and stream over the internet data generated by your MCU project
* [Jumpstarter](https://github.com/jumpstarter-dev/jumpstarter) ⭐ 219 | 🐛 171 | 🌐 Python | 📅 2026-09-14 - Open source hardware-in-the-loop testing framework for automated testing on real and virtual embedded hardware with CI/CD integration.
...
* [Curated list of awesome lists](https://github.com/sindresorhus/awesome) ⭐ 506,046 | 🐛 106 | 📅 2026-09-02
* [Curated list of project-based tutorials](https://github.com/tuvtran/project-based-learning) ⭐ 283,325 | 🐛 252 | 🌐 Python | 📅 2026-09-14
* [A curated list of awesome Raspberry Pi tools, projects, images and resources](https://github.com/thibmaek/awesome-raspberry-pi) ⭐ 16,878 | 🐛 26 | 🌐 Shell | 📅 2026-07-27
* [awesome-embedded-rust](https://github.com/rust-embedded/awesome-embedded-rust) ⭐ 8,088 | 🐛 16 | 📅 2026-09-11 - Curated list of resources for Embedded and Low-level development in the Rust programming language.
...
* [awesome-embedded-systems](https://github.com/embedded-boston/awesome-embedded-systems) ⭐ 1,017 | 🐛 8 | 📅 2024-01-04
* [theEmbeddedNewTestament.github.io](https://github.com/theEmbeddedGeorge/theEmbeddedNewTestament.github.io) ⭐ 975 | 🐛 2 | 🌐 C | 📅 2026-06-27
