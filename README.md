...
* [Coding Interview University](https://github.com/jwasham/coding-interview-university) ⭐ 358,643 | 🐛 124 | 📅 2025-08-28 - A complete computer science study plan to become a software engineer.
...
* [Modern Embedded Systems Programming Course](https://github.com/QuantumLeaps/modern-embedded-programming-course) ⭐ 1,428 | 🐛 1 | 🌐 C | 📅 2026-07-07 - Learn from the basics to modern embedded programming practice.
...
* [Bare metal programming guide](https://github.com/cpq/bare-metal-programming-guide) ⭐ 4,816 | 🐛 2 | 🌐 C | 📅 2026-07-03 - a detailed guide for beginners
* [Real-Time C++](https://github.com/ckormanyos/real-time-cpp) ⭐ 800 | 🐛 10 | 🌐 C++ | 📅 2026-08-08 - companion bare-metal code to Real-Time C++ book.
...
* [Standalone TCP/IP stack for STM32, bare metal or RTOS](https://github.com/cesanta/mongoose) ⭐ 12,990 | 🐛 3 | 🌐 C | 📅 2026-08-13
...
* [Lightweight USB device Stack for STM32 microcontrollers](https://github.com/dmitrystu/libusb_stm32) ⭐ 824 | 🐛 29 | 🌐 C | 📅 2025-10-06
...
* [Linux inside](https://github.com/0xAX/linux-insides) ⭐ 32,910 | 🐛 23 | 🌐 Python | 📅 2026-08-06 - A little bit about a linux kernel
...
* [Linux Kernel Exploitation](https://github.com/xairy/linux-kernel-exploitation) ⭐ 6,593 | 🐛 1 | 📅 2026-07-06 - A bunch of links related to Linux kernel exploitation
...
* [RT-Thread is an open source IoT operating system from China.](https://github.com/RT-Thread/rt-thread) ⭐ 12,147 | 🐛 485 | 🌐 C | 📅 2026-08-13
* [30 Days make OS](https://github.com/yourtion/30dayMakeOS) ⭐ 6,441 | 🐛 12 | 🌐 C | 📅 2024-04-01 --> [YOS](https://github.com/yourtion/YOS) ⭐ 264 | 🐛 2 | 🌐 C | 📅 2021-05-24 @[Yannik](https://yannik520.github.io/)
* [tock](https://github.com/tock/tock) ⭐ 6,410 | 🐛 207 | 🌐 Rust | 📅 2026-08-13 - A secure embedded operating system for Cortex-M based microcontrollers.
...
* [Real-Time Kernel '0'](https://github.com/antoniogiacomelli/RK0) ⭐ 14 | 🐛 0 | 🌐 C | 📅 2026-08-12 - A lean, highly deterministic, low-latency real-time kernel for ARMv6/7M.
...
* [automotive software(OSEK & AUTOSAR) ](https://github.com/parai/as) ⭐ 1,049 | 🐛 11 | 🌐 C | 📅 2026-01-18 - Because I am not powerful so I decided to develop tiny but smart part of automotive software based on open source, and create a general AUTOSAR & Automotive Software study environment.
...
* [BlackFlag ECU](https://github.com/bad-antics/blackflag-ecu) ⭐ 32 | 🐛 3 | 📅 2026-02-27 - Automotive CAN bus security testing and analysis tool for ECU research, fuzzing, and reverse engineering of vehicle communication protocols.

## OS

* [Bootstrap yourself to write an OS from scratch. A book for self-learner.](https://github.com/tuhdo/os01) ⭐ 13,674 | 🐛 66 | 🌐 TeX | 📅 2024-03-26
...
* [OpenBLT](https://github.com/feaser/openblt) ⭐ 963 | 🐛 0 | 🌐 C | 📅 2026-07-14 - an open source and portable bootloader for microcontrollers.
...
* [tinyusb](https://github.com/hathach/tinyusb) ⭐ 7,032 | 🐛 240 | 🌐 C | 📅 2026-08-13 - An open source USB stack for a variety of Embedded Systems.

## Others

* [apollo](https://github.com/ApolloAuto/apollo) ⭐ 26,794 | 🐛 1,045 | 🌐 C++ | 📅 2026-04-16 - An open autonomous driving platform.
* [A C++ template library for embedded applications](https://github.com/ETLCPP/etl) ⭐ 3,091 | 🐛 68 | 🌐 C++ | 📅 2026-08-13
* [Advanced fault backtrace library for ARM Cortex-M series MCU](https://github.com/armink/CmBacktrace) ⭐ 2,151 | 🐛 47 | 🌐 C | 📅 2026-05-21
* [DirtyJTAG](https://github.com/jeanthom/DirtyJTAG) ⭐ 622 | 🐛 10 | 🌐 C | 📅 2026-03-10 - JTAG adapter firmware for STM32F1
* [mcu-starter-projects](https://github.com/ataradov/mcu-starter-projects) ⭐ 341 | 🐛 5 | 🌐 C | 📅 2025-11-08 - Simple starter projects for bare-metal MCU development.
...
* [nn2](https://github.com/facex-engine/facex/tree/master/nn2) ⭐ 332 | 🐛 6 | 🌐 C | 📅 2026-05-14 - Tiny zero-dependency neural network inference engine in pure C with hand-written SIMD kernels (AVX-512 / AVX2 / NEON). Runs the FaceX face recognition stack on Apple Silicon, ARM SBCs and ESP32-P4. Apache 2.0.
...
* [voicute](https://github.com/voicute/onnx-wakeword) ⭐ 54 | 🐛 0 | 🌐 C | 📅 2026-08-11 - Lightweight keyword spotting and wake word detection engine for ESP32 with INT8 quantization (\~74KB per keyword), multi-language support including Chinese, and cross-platform ONNX Runtime inference.
...
* [Serial Studio](https://github.com/Serial-Studio/Serial-Studio) ⭐ 7,107 | 🐛 22 | 🌐 C++ | 📅 2026-08-12 - Visualize, analyze and stream over the internet data generated by your MCU project
* [mspdebug](https://github.com/dlbeer/mspdebug) ⭐ 215 | 🐛 57 | 🌐 C | 📅 2025-11-13 - Debugging tool for MSP430 MCUs
* [Jumpstarter](https://github.com/jumpstarter-dev/jumpstarter) ⭐ 209 | 🐛 181 | 🌐 Python | 📅 2026-08-13 - Open source hardware-in-the-loop testing framework for automated testing on real and virtual embedded hardware with CI/CD integration.
...
* [pycs](https://github.com/deadsy/pycs) ⭐ 80 | 🐛 1 | 🌐 Python | 📅 2023-02-27 - Python Based ARM CoreSight Debug and Trace Tools
...
* [Curated list of awesome lists](https://github.com/sindresorhus/awesome) ⭐ 495,336 | 🐛 99 | 📅 2026-06-30
* [Curated list of project-based tutorials](https://github.com/tuvtran/project-based-learning) ⭐ 279,044 | 🐛 267 | 🌐 Python | 📅 2026-08-10
* [A curated list of awesome Raspberry Pi tools, projects, images and resources](https://github.com/thibmaek/awesome-raspberry-pi) ⭐ 16,725 | 🐛 17 | 🌐 Shell | 📅 2026-07-27
...
* [awesome-embedded-systems](https://github.com/embedded-boston/awesome-embedded-systems) ⭐ 1,002 | 🐛 8 | 📅 2024-01-04
